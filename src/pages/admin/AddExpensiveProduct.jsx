...
export default function AddExpensiveProduct() {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in-up">
      <div className="flex items-center justify-between mb-8">
        <div>
           <h1 className="text-3xl font-bold text-primary dark:text-white mb-2">Add Expensive Item</h1>
           <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400">Add a high-ticket item requiring direct contact.</p>
        </div>
        <button 
