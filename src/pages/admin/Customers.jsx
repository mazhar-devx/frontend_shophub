    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-gray-600">Manage customer accounts</p>
        </div>
        <div className="flex space-x-3">
          ...
          <button className="bg-purple-600 text-primary dark:text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors flex items-center">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-500 uppercase tracking-wider">Email</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-500 uppercase tracking-wider">Phone</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-500 uppercase tracking-wider">Orders</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-500 uppercase tracking-wider">Total Spent</th>
              ...
              {currentCustomers.length > 0 ? (
                currentCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-500">{customer.email}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-500">{customer.phone}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-500">{customer.orders}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-500">${customer.totalSpent.toFixed(2)}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr>
                  <td colSpan="7" className="px-6 py-4 text-center text-sm text-gray-600 dark:text-gray-500">
                    No customers found
                  </td>
                </tr>
              )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/10 dark:bg-black/50 backdrop-blur-sm">
           <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
              <div className="p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                 ...
                 <button onClick={() => setSelectedCustomer(null)} className="text-gray-600 dark:text-gray-500 dark:text-gray-400 hover:text-gray-600">
              ...
              <div className="p-6 space-y-4">
                 ...
                 <div className="pt-4 flex justify-end space-x-3">
                    ...
                    <button 
                       ...
                       className="px-4 py-2 bg-purple-600 text-primary dark:text-white rounded-lg hover:bg-purple-700"
                    >
                       Save Changes
                    </button>
                 </div>
