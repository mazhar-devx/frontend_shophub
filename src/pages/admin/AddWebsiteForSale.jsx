...
export default function AddWebsiteForSale() {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in-up">
      <div className="flex items-center justify-between mb-8">
        <div>
           <h1 className="text-3xl font-bold text-primary dark:text-white mb-2">Add Website for Sale</h1>
           <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400">Add a digital business or website for sale.</p>
        </div>
        <button 
           ...
           <form onSubmit={handleSubmit} className="glass p-8 rounded-2xl border border-black/5 dark:border-white/10 space-y-6 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                 <div className="space-y-2 md:col-span-2">
                    <label className="text-gray-600 dark:text-gray-300 text-sm font-bold ml-1">Live Website Link</label>
                    <input 
                      type="url" 
                      name="liveLink" 
                 ...
                 <div className="space-y-2">
                    <label className="text-gray-600 dark:text-gray-300 text-sm font-bold ml-1">WhatsApp Number</label>
                    <input 
                      type="text" 
                      name="whatsappNumber" 
                 ...
                 <div className="space-y-2">
                    <label className="text-gray-600 dark:text-gray-300 text-sm font-bold ml-1">Contact Email</label>
                    <input 
                      type="email" 
                      name="contactEmail" 
                      value={formData.contactEmail} 
                      onChange={handleChange}
                      placeholder="e.g. contact@luxurycars.com"
                      className="w-full bg-black/30 border border-black/5 dark:border-white/10 rounded-xl p-4 text-primary dark:text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                    />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="space-y-2">
                    <label className="text-gray-600 dark:text-gray-300 text-sm font-bold ml-1">Category (e.g. Website, App, Domain)</label>
                    <select 
                      name="category" 
