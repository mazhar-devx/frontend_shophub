          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`appearance-none block w-full px-4 py-3 bg-white/5 border ${validationErrors.name ? 'border-red-500' : 'border-white/10'} rounded-xl placeholder-gray-500 text-primary dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                 className={`appearance-none block w-full px-4 py-3 bg-white/5 border ${validationErrors.passwordConfirm ? 'border-red-500' : 'border-white/10'} rounded-xl placeholder-gray-500 text-primary dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all`}
                placeholder="••••••••"
              />
            </div>
          </div>
