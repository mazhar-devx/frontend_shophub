              ...
              <nav className="space-y-3">
                {['Home', 'Products', 'Categories', 'Deals'].map((item) => (
                  <Link 
                    ...
                    className="block px-4 py-3 text-base font-medium text-primary dark:text-gray-200 hover:bg-white/10 hover:text-cyan-400 rounded-xl transition-all"
                    onClick={toggleMenu}
                  >
                    {item}
                  </Link>
                ...
                {!isAuthenticated ? (
                  <>
                    ...
                    <Link 
                      to="/register" 
                      className="block px-4 py-3 text-base font-medium text-secondary dark:text-gray-200 border border-white/20 hover:bg-white/5 rounded-xl text-center"
                      onClick={toggleMenu}
                    >
                      Register
                    </Link>
                  ...
                  <>
                    <Link 
                      to="/profile" 
                      className="block px-4 py-3 text-base font-medium text-secondary dark:text-gray-200 hover:bg-white/10 hover:text-cyan-400 rounded-xl transition-all"
                      onClick={toggleMenu}
                    >
                      Profile
                    </Link>
