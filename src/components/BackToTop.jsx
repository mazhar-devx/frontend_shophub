...
export default function BackToTop() {
  ...
  return (
    <div className={`fixed max-md:bottom-24 bottom-8 left-8 z-50 transition-all duration-500 transform ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 pointer-events-none"}`}>
      <button
        onClick={scrollToTop}
